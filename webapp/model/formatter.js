sap.ui.define([
    ...
    return {
        ...
        /**
         * Formats the supplier's unit price and total price for display in the table
         *
         * @public
         * @param {string} sUnitPrice The unit price as a string
         * @param {string} sTotalPrice The total price as a string
         * @returns {string} A string containing the formatted unit price and total price
         */
        formatSupplierPrice: function (sUnitPrice, sTotalPrice) {
            return this.currencyValue(sUnitPrice) + " - " + this.currencyValue(sTotalPrice);
        }
    };
});